...
function Footer() {
  return (
    <div className="max-w-full">
      <div role="contentinfo" className="member-footer pt-10" id="member-footer">
        <div className="social-links flex my-5 ">
          <a className="pr-5" href="#" target="_blank" aria-label="facebook">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <a className="pr-5" href="#" target="_blank" aria-label="instagram">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <a className="pr-5" href="#" target="_blank" aria-label="twitter">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <ul className="member-footer-links grid grid-flow-col">
          <div className="col-span-6">
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="/browse/audio-description">
                <span className="member-footer-link-content">Audiodeskription</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="https:www.google.com">
                <span className="member-footer-link-content">Hilfe-Center</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="/redeem">
                <span className="member-footer-link-content">Geschenkkarten</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="www.google.com">
                <span className="member-footer-link-content">Medien-Center</span>
              </a>
            </li>
          </div>
          <div className="col-span-6">
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="#">
                <span className="member-footer-link-content">Anlegerbeziehungen</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="#">
                <span className="member-footer-link-content">Karriere</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="#">
                <span className="member-footer-link-content">Nutzungsbedingungen</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="#">
                <span className="member-footer-link-content">Datenschutz</span>
              </a>
            </li>
            <li className="member-footer-link-wrapper">
              <a className="member-footer-link" href="#">
                <span className="member-footer-link-content">Rechtliche Hinweise</span>
              </a>
            </li>
          </div>
        </ul>
