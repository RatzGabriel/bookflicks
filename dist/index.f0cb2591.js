 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wm{constructor(e){this.value=e}static empty(){return new wm({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!$p(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Hp(t)}setAll(e){let t=ep.emptyPath(),n={},r=[];e.forEach(((e,i)=>{if(!t.isImmediateParentOf(i)){const e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=Hp(e):r.push(i.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){const t=this.field(e.popLast());$p(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ap(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];$p(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){gp(t,((t,n)=>e[t]=n));for(const t of n)delete e[t]}clone(){return new wm(Hp(this.value))}}function Sm(e){const t=[];return gp(e.fields,((e,n)=>{const r=new ep([e]);if($p(n)){const e=Sm(n.mapValue).fields;if(0===e.length)t.push(r);else for(const n of e)t.push(r.child(n))}else t.push(r)})),new bm(t)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bg{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,$g.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Bg(Xf.min(),r,Vg(),Ng(),Ug())}}class $g{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new $g(n,t,Ug(),Ug(),Ug())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bw{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new dw(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new $w(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Hw("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class $w extends Bw{data(){return super.data()}}function Hw(e,t){return"string"==typeof t?Uw(e,t):t instanceof Ew?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VS="firebase-installations-database",BS=1,$S="firebase-installations-store";let HS=null;function qS(){return HS||(HS=Ul(VS,BS,{upgrade:(e,t)=>{if(0===t)e.createObjectStore($S)}})),HS}async function WS(e,t){const n=DS(e),r=(await qS()).transaction($S,"readwrite"),i=r.objectStore($S),o=await i.get(n);return await i.put(t,n),await r.done,o&&o.fid===t.fid||MS(e,t.fid),t}async function KS(e){const t=DS(e),n=(await qS()).transaction($S,"readwrite");await n.objectStore($S).delete(t),await n.done}async function GS(e,t){const n=DS(e),r=(await qS()).transaction($S,"readwrite"),i=r.objectStore($S),o=await i.get(n),s=t(o);return void 0===s?await i.delete(n):await i.put(s,n),await r.done,!s||o&&o.fid===s.fid||MS(e,s.fid),s}
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
***************************************************************************** */
function H_(e,t,n,r){return new(n||(n=Promise))((function(i,o){function s(e){try{l(r.next(e))}catch(e){o(e)}}function a(e){try{l(r.throw(e))}catch(e){o(e)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(s,a)}l((r=r.apply(e,t||[])).next())}))}function q_(e,t){var n,r,i,o,s={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return o={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o;function a(o){return function(a){return function(o){if(n)throw new TypeError("Generator is already executing.");for(;s;)try{if(n=1,r&&(i=2&o[0]?r.return:o[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,o[1])).done)return i;switch(r=0,i&&(o=[2&o[0],i.value]),o[0]){case 0:case 1:i=o;break;case 4:return s.label++,{value:o[1],done:!1};case 5:s.label++,r=o[1],o=[0];continue;case 7:o=s.ops.pop(),s.trys.pop();continue;default:if(!(i=s.trys,(i=i.length>0&&i[i.length-1])||6!==o[0]&&2!==o[0])){s=0;continue}if(3===o[0]&&(!i||o[1]>i[0]&&o[1]<i[3])){s.label=o[1];break}if(6===o[0]&&s.label<i[1]){s.label=i[1],i=o;break}if(i&&s.label<i[2]){s.label=i[2],s.ops.push(o);break}i[2]&&s.ops.pop(),s.trys.pop();continue}o=t.call(e,s)}catch(e){o=[6,e],r=0}finally{n=i=0}if(5&o[0])throw o[1];return{value:o[0]?o[1]:void 0,done:!0}}([o,a])}}}
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var W_=function(){return W_=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},W_.apply(this,arguments)},K_=function(e){return{loading:null==e,value:e}},G_=function(e){var t=e?e():void 0,n=(0,m.useReducer)((function(e,t){switch(t.type){case"error":return W_(W_({},e),{error:t.error,loading:!1,value:void 0});case"reset":return K_(t.defaultValue);case"value":return W_(W_({},e),{error:void 0,loading:!1,value:t.value});default:return e}}),K_(t)),r=n[0],i=n[1],o=(0,m.useCallback)((function(){var t=e?e():void 0;i({type:"reset",defaultValue:t})}),[e]),s=(0,m.useCallback)((function(e){i({type:"error",error:e})}),[]),a=(0,m.useCallback)((function(e){i({type:"value",value:e})}),[]);return(0,m.useMemo)((function(){return{error:r.error,loading:r.loading,reset:o,setError:s,setValue:a,value:r.value}}),[r.error,r.loading,o,s,a,r.value])},Q_=function(e,t){var n=G_((function(){return e.currentUser})),r=n.error,i=n.loading,o=n.setError,s=n.setValue,a=n.value;return(0,m.useEffect)((function(){var n=Sx(e,(function(e){return H_(void 0,void 0,void 0,(function(){var n;return q_(this,(function(r){switch(r.label){case 0:if(!(null==t?void 0:t.onUserChanged))return[3,4];r.label=1;case 1:return r.trys.push([1,3,,4]),[4,t.onUserChanged(e)];case 2:return r.sent(),[3,4];case 3:return n=r.sent(),o(n),[3,4];case 4:return s(e),[2]}}))}))}),o);return function(){n()}}),[e]),[a,i,r]};var X_=()=>{const[e]=Q_(JT),t=jt(),[n,r]=(0,m.useState)(!1),i=E((e=>e.favorites.items));return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("div",{className:"z-50 h-20 flex  md:w-full  top-0 justify-between ",children:[(0,s.jsxs)("div",{className:"flex flex-col items-center justify-between w-full ",children:[(0,s.jsxs)("div",{className:"flex items-center justify-between w-full",children:[(0,s.jsxs)("div",{className:"flex items-center",children:[(0,s.jsx)(U_,{onClick:()=>{setTimeout((()=>{r(!n)}),50)},className:" md:hidden text-[2em] "}),(0,s.jsx)(fn,{to:"/",children:(0,s.jsx)("img",{"data-testid":"logo",className:"h-20 ",src:"https://d1csarkz8obe9u.cloudfront.net/posterpreviews/bookstore-logo-design-template-33f3abd4285d1eeccd6c235cbeb0b964_screen.jpg?ts=1659428394",alt:"logo"})}),(0,s.jsxs)("div",{className:"hidden md:flex",children:[(0,s.jsx)(fn,{className:("/"===t.pathname?"text-red-400":"")+" px-4",to:"/",children:"Home"}),(0,s.jsxs)(fn,{className:("/favorites"===t.pathname?"text-red-400":"")+" px-4",to:"/favorites",children:["Favorites",(0,s.jsx)("span",{className:"text-xs mx-1 ","data-testid":"booklength",children:null!=i?.length&&i.length})]}),(0,s.jsx)(fn,{className:("/comedy"===t.pathname?"text-red-400":"")+" px-4",to:"/comedy",children:"comedy"}),(0,s.jsx)(fn,{className:("/crime"===t.pathname?"text-red-400":"")+" px-4",to:"/crime",children:"crime"}),(0,s.jsx)(fn,{className:("/fantasy"===t.pathname?"text-red-400":"")+" px-4",to:"/fantasy",children:"fantasy"})]})]}),(0,s.jsx)("div",{className:"md:hidden ",children:e?(0,s.jsx)(e_,{}):(0,s.jsx)(t_,{})})]}),(0,s.jsx)("div",{className:"w-full md:hidden",children:(0,s.jsx)($_,{})})]}),(0,s.jsxs)("div",{"data-testid":"links",className:" hidden md:flex justify-between items-center w-6/12 text-3xl ",children:[(0,s.jsx)("div",{className:"w-full hidden md:inline-block",children:(0,s.jsx)($_,{})}),e?(0,s.jsx)(e_,{}):(0,s.jsx)(t_,{})]})]}),n&&(0,s.jsx)(V_,{setMenu:r})]})};var Y_=(0,go.configureStore)({reducer:{favorites:u_,books:k_,user:XT},middleware:e=>e({serializableCheck:!1})});m=o("acw62");var J_=()=>{const e=$(),t=E((e=>e.favorites.items)),n=E((e=>e.user.user));return(0,m.useEffect)((()=>{!function(e){const t=JT.onAuthStateChanged((t=>{e(QT(t||null))}))}(e)}),[e]),(0,m.useEffect)((()=>{null!=n&&e(s_(null,{extra:{user:n}}))}),[n]),(0,m.useEffect)((()=>{null!=n&&e(s_(null,{extra:{user:n}}))}),[]),t&&null!=t&&0!=t.length?(0,s.jsx)(v_,{books:t,title:"Favorites"}):(0,s.jsx)("div",{className:"text-3xl font-bold text-center mt-20",children:"No favorites yet"})},Z_=(m=o("acw62"),o("99b6d"));var eC=({categorie:e})=>{const{load:t}=C_(),r=E((e=>e.books.allBooks.fantasy)),i=E((e=>e.books.allBooks.comedy)),o=E((e=>e.books.allBooks.crime)),a=E((e=>e.books.loading)),[l,u]=(0,m.useState)([]);return(0,m.useEffect)((()=>{console.log(a),a||u("fantasy"===e?r:"comedy"===e?i:o),0==r.length&&t()}),[e,a,r,i,o,u]),(0,s.jsxs)("div",{className:"max-h-50 pt-24 md: min-h-screen","data-testid":"categorie-title",children:[(0,s.jsx)(T_,{}),(0,s.jsxs)("div",{className:"md:hidden min-h-screen",children:[(0,s.jsx)("h1",{className:Pn,children:e}),(0,s.jsx)(n(Z_),{className:" max-h-60 md:hidden w-72 ",...xn,children:l&&l.map((e=>(0,s.jsx)(d_,{book:e},e.id)))})]}),(0,s.jsx)("div",{className:"hidden md:flex",children:(0,s.jsxs)("div",{className:"mx-auto py-4 w-full",children:[(0,s.jsx)("h2",{className:"text-2xl font-bold tracking-tight text-white-900",children:e}),(0,s.jsx)("div",{className:"mt-1 grid grid-cols-1 gap-y-5 gap-x-6 sm:grid-cols-2 lg:grid-cols-9 xl:gap-x-8",children:l&&l.map((e=>(0,s.jsx)(d_,{book:e},e.id)))}),(0,s.jsx)("div",{children:0==l.length&&"No books in this categorie"})]})})]})};const tC=()=>(0,s.jsx)("div",{className:"bg-black text-white w-full ",children:(0,s.jsx)("div",{className:"mx-auto w-4/5 min-h-screen",children:(0,s.jsxs)(U,{store:Y_,children:[(0,s.jsx)(X_,{}),(0,s.jsx)(Yt,{}),(0,s.jsx)(N_,{})]})})}),nC=(rC=[{path:"/",element:(0,s.jsx)(tC,{}),errorElement:(0,s.jsx)(O_,{}),children:[{path:"/",element:(0,s.jsx)(I_,{})},{path:"/favorites",element:(0,s.jsx)(J_,{})},{path:"/fantasy",element:(0,s.jsx)(eC,{categorie:"fantasy"})},{path:"/comedy",element:(0,s.jsx)(eC,{categorie:"comedy"})},{path:"/crime",element:(0,s.jsx)(eC,{categorie:"crime"})}]}],We({basename:null==iC?void 0:iC.basename,history:X({window:null==iC?void 0:iC.window}),hydrationData:(null==iC?void 0:iC.hydrationData)||cn(),routes:sn(rC)}).initialize());var rC,iC;n(u).createRoot(document.getElementById("root")).render((0,s.jsx)((function(e){let{fallbackElement:t,router:n}=e,r=It(n.subscribe,(()=>n.state),(()=>n.state)),i=m.useMemo((()=>({createHref:n.createHref,encodeLocation:n.encodeLocation,go:e=>n.navigate(e),push:(e,t,r)=>n.navigate(e,{state:t,preventScrollReset:null==r?void 0:r.preventScrollReset}),replace:(e,t,r)=>n.navigate(e,{replace:!0,state:t,preventScrollReset:null==r?void 0:r.preventScrollReset})})),[n]),o=n.basename||"/";return m.createElement(m.Fragment,null,m.createElement(Ot.Provider,{value:{router:n,navigator:i,static:!1,basename:o}},m.createElement(Nt.Provider,{value:r},m.createElement(Zt,{basename:n.basename,location:n.state.location,navigationType:n.state.historyAction,navigator:i},n.state.initialized?m.createElement(en,null):t))),null)}),{router:nC}));
//# sourceMappingURL=index.f0cb2591.js.map
