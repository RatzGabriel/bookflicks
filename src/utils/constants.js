// Links
export const BOOKS_LOGO_SRC =
  'https://d1csarkz8obe9u.cloudfront.net/posterpreviews/bookstore-logo-design-template-33f3abd4285d1eeccd6c235cbeb0b964_screen.jpg?ts=1659428394';
...
export const LANDINGPAGE_IMAGE =
  'https://images.unsplash.com/photo-1526243741027-444d633d7365?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1742&q=80';

export const PLACEHOLDER_COVER =
  'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Placeholder_book.svg/1200px-Placeholder_book.svg.png';

// Text
export const CONTAINER_TITLE_1 = 'Fantasy';
export const CONTAINER_TITLE_2 = 'Comedy';
export const CONTAINER_TITLE_3 = 'Crime';
export const TOP_TITLE_1 = 'TOP 10 Books today';
export const TOP_TITLE_2 = 'TOP 10 Books in Austria';

// Icons

export const RANK_ONE = (
  <svg
    id="rank-1"
    width="100%"
    height="100%"
    viewBox="-20 0 70 154"
    className="h-full pointer-events-none w-full  svg-icon-rank-1 top-10-rank"
  >
    <path
      stroke="#595959"
...
export const RANK_TWO = (
  <svg
    id="rank-2"
    width="100%"
    height="100%"
    viewBox="0 0 80 154"
    className="h-full pointer-events-none w-full  svg-icon-rank-2 top-10-rank"
  >
    <path
      stroke="#595959"
      strokeLinejoin="square"
...
export const RANK_THREE = (
  <svg
    id="rank-3"
    width="100%"
    height="100%"
    viewBox="0 0 80 154"
    className="h-full pointer-events-none w-full  svg-icon-rank-3 top-10-rank"
  >
    <path
      stroke="#595959"
      strokeLinejoin="square"
...
export const RANK_FOUR = (
  <svg
    id="rank-4"
    width="100%"
    height="100%"
    viewBox="0 0 81 154"
    className="h-full pointer-events-none w-full  svg-icon-rank-4 top-10-rank"
  >
    <path
      stroke="#595959"
      strokeLinejoin="square"
...
export const RANK_FIVE = (
  <svg
    id="rank-5"
    width="100%"
    height="100%"
    viewBox="0 0 81 154"
    className="h-full pointer-events-none w-full  svg-icon-rank-5 top-10-rank"
  >
    <path
      stroke="#595959"
      strokeLinejoin="square"
