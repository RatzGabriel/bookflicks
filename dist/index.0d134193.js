...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var W_=function(){return W_=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},W_.apply(this,arguments)},K_=function(e){return{loading:null==e,value:e}},G_=function(e){var t=e?e():void 0,n=(0,m.useReducer)((function(e,t){switch(t.type){case"error":return W_(W_({},e),{error:t.error,loading:!1,value:void 0});case"reset":return K_(t.defaultValue);case"value":return W_(W_({},e),{error:void 0,loading:!1,value:t.value});default:return e}}),K_(t)),r=n[0],i=n[1],o=(0,m.useCallback)((function(){var t=e?e():void 0;i({type:"reset",defaultValue:t})}),[e]),s=(0,m.useCallback)((function(e){i({type:"error",error:e})}),[]),a=(0,m.useCallback)((function(e){i({type:"value",value:e})}),[]);return(0,m.useMemo)((function(){return{error:r.error,loading:r.loading,reset:o,setError:s,setValue:a,value:r.value}}),[r.error,r.loading,o,s,a,r.value])};var Q_=()=>{const[e]=(t=JT,r=G_((function(){return t.currentUser})),i=r.error,o=r.loading,a=r.setError,l=r.setValue,u=r.value,(0,m.useEffect)((function(){var e=Sx(t,(function(e){return H_(void 0,void 0,void 0,(function(){var t;return q_(this,(function(r){switch(r.label){case 0:if(!(null==n?void 0:n.onUserChanged))return[3,4];r.label=1;case 1:return r.trys.push([1,3,,4]),[4,n.onUserChanged(e)];case 2:return r.sent(),[3,4];case 3:return t=r.sent(),a(t),[3,4];case 4:return l(e),[2]}}))}))}),a);return function(){e()}}),[t]),[u,o,i]);var t,n,r,i,o,a,l,u;const c=jt(),[d,h]=(0,m.useState)(!1),f=E((e=>e.favorites.items));return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("div",{className:"z-50 h-20 flex  md:w-full  top-0 ",children:[(0,s.jsxs)("div",{className:"flex items-center justify-between w-full ",children:[(0,s.jsx)(U_,{onClick:()=>{setTimeout((()=>{h(!d)}),50)},className:" md:hidden text-[2em] "}),(0,s.jsx)(fn,{to:"/",children:(0,s.jsx)("img",{"data-testid":"logo",className:"h-20 ",src:"https://d1csarkz8obe9u.cloudfront.net/posterpreviews/bookstore-logo-design-template-33f3abd4285d1eeccd6c235cbeb0b964_screen.jpg?ts=1659428394",alt:"logo"})}),(0,s.jsx)(B_,{})]}),(0,s.jsxs)("div",{"data-testid":"links",className:" hidden md:flex justify-between items-center w-3/12 text-3xl ",children:[(0,s.jsxs)("div",{className:"flex items-center ",children:[(0,s.jsx)(fn,{className:("/"===c.pathname?"text-red-400":"")+" px-4  font-bold",to:"/",children:"Home"}),e?(0,s.jsx)(e_,{}):(0,s.jsx)(t_,{})]}),(0,s.jsxs)("div",{className:"flex items-center ",children:[(0,s.jsx)(fn,{className:("/favorites"===c.pathname?"text-red-400":"")+"  text-3xl font-bold",to:"/favorites",children:"Favorites"}),(0,s.jsx)("span",{className:"text-xs mx-3 ","data-testid":"booklength",children:null!=f?.length&&f.length})]})]})]}),d&&(0,s.jsx)(V_,{setMenu:h})]})};var X_=(0,go.configureStore)({reducer:{favorites:c_,books:x_,user:XT},middleware:e=>e({serializableCheck:!1})});m=o("acw62");var Y_=()=>{const e=B(),t=E((e=>e.favorites.items)),n=E((e=>e.user.user));return(0,m.useEffect)((()=>{!function(e){const t=JT.onAuthStateChanged((t=>{e(t?setUser(t):setUser(null))}))}(e)}),[e]),(0,m.useEffect)((()=>{console.log(n),e(a_(null,{extra:{user:n}}))}),[n]),t&&null!=t&&0!=t.length?(0,s.jsx)(y_,{books:t,title:"Favorites"}):(0,s.jsx)("div",{className:"text-3xl font-bold text-center mt-20",children:"No favorites yet"})};const J_=()=>(0,s.jsx)("div",{className:"bg-black text-white w-full ",children:(0,s.jsx)("div",{className:"mx-auto w-4/5 min-h-screen",children:(0,s.jsxs)(U,{store:X_,children:[(0,s.jsx)(Q_,{}),(0,s.jsx)(Yt,{}),(0,s.jsx)(N_,{})]})})}),Z_=(eC=[{path:"/",element:(0,s.jsx)(J_,{}),errorElement:(0,s.jsx)(O_,{}),children:[{path:"/",element:(0,s.jsx)(I_,{})},{path:"/favorites",element:(0,s.jsx)(Y_,{})}]}],We({basename:null==tC?void 0:tC.basename,history:X({window:null==tC?void 0:tC.window}),hydrationData:(null==tC?void 0:tC.hydrationData)||cn(),routes:sn(eC)}).initialize());var eC,tC;n(u).createRoot(document.getElementById("root")).render((0,s.jsx)((function(e){let{fallbackElement:t,router:n}=e,r=It(n.subscribe,(()=>n.state),(()=>n.state)),i=m.useMemo((()=>({createHref:n.createHref,encodeLocation:n.encodeLocation,go:e=>n.navigate(e),push:(e,t,r)=>n.navigate(e,{state:t,preventScrollReset:null==r?void 0:r.preventScrollReset}),replace:(e,t,r)=>n.navigate(e,{replace:!0,state:t,preventScrollReset:null==r?void 0:r.preventScrollReset})})),[n]),o=n.basename||"/";return m.createElement(m.Fragment,null,m.createElement(Ot.Provider,{value:{router:n,navigator:i,static:!1,basename:o}},m.createElement(Nt.Provider,{value:r},m.createElement(Zt,{basename:n.basename,location:n.state.location,navigationType:n.state.historyAction,navigator:i},n.state.initialized?m.createElement(en,null):t))),null)}),{router:Z_}));
//# sourceMappingURL=index.0d134193.js.map
