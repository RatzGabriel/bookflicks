...
function ContainerTitle({ books, title, isSearchResult, row }) {
  let topBooks;
  if (row === '1') {
  ...
  return (
    <div className="max-h-50 pt-24 md:" data-testid="container-title">
      <div className="md:hidden">
        <h1 className={titleClass}>{isSearchResult ? 'SearchResults' : title}</h1>
        <Slider
      ...
      <div className="hidden md:flex">
        <div className="mx-auto  py-4 w-full">
          <h2 className="text-2xl font-bold tracking-tight text-white-900">{title}</h2>
